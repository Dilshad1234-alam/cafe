...
export default function CustomerToolbar({ totalCustomers }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
      <div>
        <h1 className="text-2xl font-black text-brand-charcoal">Customers</h1>
        <p className="text-gray-500 font-medium mt-1">Manage {totalCustomers > 0 ? `${totalCustomers} ` : ''}customer accounts</p>
      </div>
