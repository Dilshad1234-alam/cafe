      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="col-span-1 space-y-4">
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
            ...
            <p className="text-gray-500 text-sm">{user?.email || "Email not provided"}</p>
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6">
              <div className="sm:col-span-1">
                ...
                <dd className="mt-1 text-base text-gray-900">{user?.fullname || "not provided"}</dd>
              </div>
              <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500">Email Address</dt>
                <dd className="mt-1 text-base text-gray-900">{user?.email || "Not provided"}</dd>
              </div>
              <div className="sm:col-span-1">
